...
namespace Tce {
    ...
    inline void Matrix::TransformVector3(const Vector3 &position, Vector3 &result) const {
    ...
    inline Vector3 Matrix::TransformVector3(const Vector3 &position) const {
        Vector3 result;
        TransformVector3(position, result);
        return result;
    }

    inline void Matrix::TransformVector4(const Vector4 &value, Vector4 &result) const {
    ...
    inline Vector4 Matrix::TransformVector4(const Vector4 &value) const {
        Vector4 result;
        TransformVector4(value, result);
        return result;
    }

    inline void Matrix::TransformVector4(const Vector3 &value, Vector4 &result) const {
        result.x = (value.x * _11) + (value.y * _21) + (value.z * _31) +
                   (_41);
        result.y = (value.x * _12) + (value.y * _22) + (value.z * _32) +
                   (_42);
    ...
    inline Vector4 Matrix::TransformVector4(const Vector3 &value) const {
        Vector4 result;
        TransformVector4(value, result);
        return result;
    }

    inline void Matrix::TransformVector4(const Vector2 &value, Vector4 &result) const {
    ...
    inline Vector4 Matrix::TransformVector4(const Vector2 &value) const {
        Vector4 result;
        TransformVector4(value, result);
        return result;
    }
    ...
    inline void Matrix::CreateLookAt(const Vector3 &cameraPosition, const Vector3 &cameraTarget,
    ...
    inline Matrix Matrix::Lerp(Matrix matrix, float amount) {
        return {
